...
begin
  ...
  begin
    LEtoNinPlace(prSize);
    LEtoNinPlace(defType2);
    LEtoNinPlace(FullHeight);
    LEtoNinPlace(FullWidth);
    LEtoNinPlace(SpriteHeight);
    LEtoNinPlace(SpriteWidth);
    LEtoNinPlace(LeftMargin);
    LEtoNinPlace(TopMargin);
  end;
